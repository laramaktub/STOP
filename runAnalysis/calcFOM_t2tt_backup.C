...
if (num==0) c1.Print("~/www/STOP/BDTTraining/8TeV/"+datasetnombre+"/BestSet/Entries_Lara_twikiweight_SR.png");
if (num==1) c1.Print("~/www/STOP/BDTTraining/8TeV/"+datasetnombre+"/BestSet/FOM_Lara_twikiweight_SR.png");
if (num==2) c1.Print("~/www/STOP/BDTTraining/8TeV/"+datasetnombre+"/BestSet/OptimalCut_Lara_twikiweight_SR.png");
if (num==3) c1.Print("~/www/STOP/BDTTraining/8TeV/"+datasetnombre+"/BestSet/BestBDT_Lara_twikiweight_SR.png");
