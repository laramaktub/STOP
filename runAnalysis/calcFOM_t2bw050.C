...
TString signalregiont2bw075(int,int);
TString signalregiont2bw025(int,int);
TString signalregiont2bw050(int,int);
...
//	  TFile sig("../Leg3_NN_Strass/"+setup+"/"+TString(stop)+"/"+TString(neut)+"/output/SMS_t2tt_0.root"); 	
 ...
 for(int b=1; b<=nbins; ++b){
	    ...
	    //cutvalue = TTBar->GetBinLowEdge(max_bin);
	    cutvalue=0.2;
	    if (BDT=="BDT2") cutvalue=0.3;
	    if (BDT=="BDT3") cutvalue=0.35;
	    if (BDT=="BDT4") cutvalue=0.25;
...
if (num==0) c1.Print("~/www/STOP/BDTTraining/8TeV/"+dataset_name+"_half/BestSet/Entries_Lara_SR_fixcut.png");
if (num==1) c1.Print("~/www/STOP/BDTTraining/8TeV/"+dataset_name+"_half/BestSet/FOM_Lara_SR_fixcut.png");
if (num==2) c1.Print("~/www/STOP/BDTTraining/8TeV/"+dataset_name+"_half/BestSet/OptimalCut_Lara_SR_fixcut.png");
if (num==3) c1.Print("~/www/STOP/BDTTraining/8TeV/"+dataset_name+"_half/BestSet/BestBDT_Lara_SR_fixcut.png");
...
TString signalregiont2bw075 (int stopmass, int lspmass)
{
  ...
  if (signalregion==1) BDT="BDT1";
   if (signalregion==2) BDT="BDT2";
  if (signalregion==3) BDT="BDT3";
  if (signalregion==4) BDT="BDT4";
   if (signalregion==5) BDT="BDT5";
    if (signalregion==6) BDT="BDT6";
...
TString signalregiont2bw025 (int stopmass, int lspmass)
{
...
TString signalregiont2bw050 (int stopmass, int lspmass)
{
